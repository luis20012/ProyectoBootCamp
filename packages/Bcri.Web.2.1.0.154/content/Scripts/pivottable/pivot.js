(function () {
    ...
    callWithJQuery(function ($) {
        ...
        Utilities
         */
        var PivotData, addSeparators, aggregatorTemplates, aggregators, dayNamesEn, derivers, getSort, locales, mthNamesEn, naturalSort, numberFormat, pivotTableRenderer, renderers, sortAs, usFmt, usFmtInt, usFmtPct, zeroPad, parseFloatExt;
                ...
                return function (arg) {
                    ...
                    return function (data, rowKey, colKey) {
                        return {
                            sum: 0,
                            push: function (record) {
                                if (!isNaN(parseFloatExt(record[attr]))) {
                                    return this.sum += parseFloatExt(record[attr]);
                                }
                            },
                            value: function () {
                                return this.sum;
                ...
                return function (arg) {
                    ...
                    return function (data, rowKey, colKey) {
                        return {
                            ...
                            push: function (record) {
                                if (!isNaN(parseFloatExt(record[attr]))) {
                                    this.sum += parseFloatExt(record[attr]);
                                    return this.len++;
                                }
                            },
                            value: function () {
                ...
                return function (arg) {
                    ...
                    return function (data, rowKey, colKey) {
                        return {
                            ...
                            sumDenom: 0,
                            push: function (record) {
                                if (!isNaN(parseFloatExt(record[num]))) {
                                    this.sumNum += parseFloatExt(record[num]);
                                }
                                if (!isNaN(parseFloatExt(record[denom]))) {
                                    return this.sumDenom += parseFloatExt(record[denom]);
                                }
                            },
                            value: function () {
