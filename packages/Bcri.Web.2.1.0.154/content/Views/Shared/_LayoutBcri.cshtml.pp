...
<head>
    ...
    @if (BundleTable.Bundles.Any(x => x.Path == "~/Content/$rootnamespace$"))
    {
        @Styles.Render("~/Content/$rootnamespace$")
    }
...
<body class="pace-done skin-1">
    ...
    @if (BundleTable.Bundles.Any(x => x.Path == "~/bundles/$rootnamespace$"))
    {
        @Scripts.Render("~/bundles/$rootnamespace$")
    }
